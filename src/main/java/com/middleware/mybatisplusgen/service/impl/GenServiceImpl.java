package com.middleware.mybatisplusgen.service.impl;
...
import com.middleware.mybatisplusgen.pojo.ColumnEntity;
import com.middleware.mybatisplusgen.pojo.TableEntity;
...
//        templates.add("template/crud.js.vm");
    ...
    public byte[] gen(String tableName) {
        ...
        String temp = table.get("tableName");
        String[] split = temp.split("_");
        String tableFirstLetter = "";
        for (String item : split) {
            tableFirstLetter += item.substring(0,1);
        }
        map.put("tableFirstLetter", tableFirstLetter);
