package com.business.exportimport.exportpdf.pojo;
...
public class Excel2Pdf extends PdfTool {
    ...
    private static class PDFPageEvent extends PdfPageEventHelper {
        ...
        public void onStartPage(PdfWriter writer, Document document) {
            try {
                this.template = writer.getDirectContent().createTemplate(50, 50);
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            Phrase footer = new Phrase(text, new Font(Resource.BASE_FONT_CHINESE, 8, Font.NORMAL));
            ColumnText.showTextAligned(byteContent, Element.ALIGN_CENTER, footer,
                    (document.rightMargin() + document.right() + document.leftMargin() - document.left() - textWidth) / 2.0F + 20F, document.bottom() - 20,
                    0);
            byteContent.addTemplate(this.template,  (document.rightMargin() + document.right() + document.leftMargin() - document.left()) / 2.0F + 20F, document.bottom() - 20);
